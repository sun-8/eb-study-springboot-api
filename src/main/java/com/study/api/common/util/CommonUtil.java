...
public class CommonUtil {
     ...
     * @return
     */
    public String nvl(String str, String defaultStr) {
        if (str == null || str.equals("")) {
            return defaultStr;
        } else {
            return str;
     ...
     * @return
     */
    public String stringCut(String str, int length) {
     ...
     * @return
     */
    public DateTimeFormatter dateFormat(LocalDate localDate, String pattern) {
        switch (pattern) {
            case "yyyy-MM-dd":
     ...
     * @return
     */
    public String localNowDate(String format) {
        LocalDate localDate = LocalDate.now();
     ...
     * @return
     */
    public String localDatePlusY(String str, int i) {
